...
Java_com_bn3monkey_securitysocket_NativeLib_tcpTest(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_bn3monkey_securitysocket_NativeLib_tlsTest(
        JNIEnv* env,
        jobject /* this */) {
    tlsTest();
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_bn3monkey_securitysocket_NativeLib_tcpAsyncTest(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_bn3monkey_securitysocket_NativeLib_tlsAsyncTest(
        JNIEnv* env,
        jobject /* this */) {
    tlsAsyncTest();
}